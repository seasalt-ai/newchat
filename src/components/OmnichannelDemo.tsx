...
const OmnichannelDemo = () => {
  ...
  const channels = [
    ...
    {
      id: 'line',
      name: t('omnichannelDemo.channels.line.name', 'Line'),
      icon: SiLine,
      color: 'bg-green-700',
      description: t('omnichannelDemo.channels.line.description', 'The most popular chat app in Japan, Taiwan, and Thailand'),
