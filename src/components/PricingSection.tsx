  ...
  const plans = [
    {
      ...
      limitations: t('pricing.plans.free.limitations', { returnObjects: true }),
    ...
    },
    {
      ...
      buttonText: t('pricing.plans.growth.button'),
        ...
        <div className="text-center mb-16">
          ...
          <div className="flex items-center justify-center mb-8">
            ...
            <span className={`ml-3 ${billingCycle === 'yearly' ? 'text-gray-900 font-medium' : 'text-gray-500'}`}>
              {t('pricing.yearly')} <span className="text-green-500 font-semibold">({t('pricing.save')})</span>
            </span>
          </div>
        </div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-4">
                  {t('pricing.chatVolume')}: <span className="font-bold text-teal-600">{chatVolume.toLocaleString()}</span>
                </label>
                <input
                  type="range"
                  min="100"
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-4">
                  {t('pricing.agents')}: <span className="font-bold text-teal-600">{agents}</span>
                </label>
                <input
                  type="range"
                  min="1"
              ...
              <div className="p-8">
                ...
                <div className="mb-6">
                  <div className="flex items-baseline">
                    ...
                    <span className="text-gray-600 ml-2">/{billingCycle === 'monthly' ? t('pricing.plans.free.period') : t('pricing.yearly').toLowerCase()}</span>
                  </div>
